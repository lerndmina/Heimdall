  ...
  return (
    <div className="space-y-1.5">
      ...
      <input
        ...
        required={required}
        disabled={disabled}
        className={`w-full rounded-lg border bg-white/5 px-3 py-2 text-sm text-zinc-100 placeholder-zinc-500 outline-none backdrop-blur-sm transition focus:ring-1 ${
