 ...
 * Kept inline to avoid an icon library dependency.
 */
...
/** Minecraft / game controller icon */
...
/** Modmail / envelope icon */
export function ModmailIcon() {
  return (
    <svg className={iconClass} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
/** Voice transcription / waveform icon */
export function VCTranscriptionIcon() {
  return (
    <svg className={iconClass} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path
        strokeLinecap="round"
...
/** PlanetSide 2 / globe-crosshair icon */
export function PlanetSideIcon() {
  return (
    <svg className={iconClass} fill="none" stroke="currentColor" viewBox="0 0 24 24">
