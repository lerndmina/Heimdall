  ...
  return (
    <>
      ...
      <div className="pointer-events-none fixed inset-0 overflow-hidden z-0">
        <div
          className={`absolute -left-[10%] top-[15%] h-[500px] w-[500px] rounded-full bg-primary-500/8 blur-[100px] transition-opacity duration-700 ${enabled ? "animate-pulse" : "opacity-60"}`}
        />
        <div
