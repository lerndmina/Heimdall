...
export const PRESETS: PresetDefinition[] = [
  {
    ...
    patterns: [
      { regex: "(?:discord\\.gg|discordapp\\.com\\/invite|discord\\.com\\/invite)\\/[\\w-]+", flags: "i", label: "Discord invite URL" },
    ],
    matchMode: "any",
  ...
  },
  {
    ...
    target: AutomodTarget.MESSAGE_CONTENT,
    patterns: [
      { regex: "(?=.{10,})(?:[^A-Za-z]*[A-Z]){7}[^a-z]*$", flags: "", label: "70%+ uppercase" },
    ],
    matchMode: "any",
    actions: [AutomodAction.DELETE, AutomodAction.WARN, AutomodAction.LOG],
    warnPoints: 1,
  },
  {
    ...
    target: AutomodTarget.MESSAGE_CONTENT,
    patterns: [
      { regex: "(.)\\1{9,}", flags: "", label: "10+ repeated chars" },
    ],
    matchMode: "any",
    actions: [AutomodAction.DELETE, AutomodAction.WARN, AutomodAction.LOG],
    warnPoints: 1,
  },
  {
    ...
    target: AutomodTarget.LINK,
    patterns: [
      { regex: "https?:\\/\\/(?!(?:discord\\.gg|discord\\.com|discordapp\\.com|cdn\\.discordapp\\.com|media\\.discordapp\\.net))[^\\s]+", flags: "i", label: "Non-Discord URL" },
    ],
    matchMode: "any",
    actions: [AutomodAction.DELETE, AutomodAction.WARN, AutomodAction.LOG],
    warnPoints: 1,
  },
  {
    ...
    target: AutomodTarget.MESSAGE_CONTENT,
    patterns: [
      { regex: "[\\u0300-\\u036f\\u0489]{3,}", flags: "", label: "Zalgo combining chars" },
    ],
    matchMode: "any",
    actions: [AutomodAction.DELETE, AutomodAction.WARN, AutomodAction.LOG],
    warnPoints: 1,
