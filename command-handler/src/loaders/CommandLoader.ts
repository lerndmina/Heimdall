...
export class CommandLoader {
  ...
  private isLegacySlashPattern(exports: any): exports is LegacyCommandData {
    return exports.data && typeof exports.run === 'function' && 
  ...
  private isLegacyContextMenuPattern(exports: any): exports is LegacyContextMenuCommandData {
    return exports.data && typeof exports.run === 'function' && 
           exports.data.name && exports.data.type && 
           (exports.data.type === 2 || exports.data.type === 3); // Message or User context menu
  }
   ...
   */
  private adaptLegacySlashCommand(
    exports: LegacyCommandData, 
    filePath: string, 
    commandName: string
  ): LoadedCommand {
    ...
    return {
      ...
      autocomplete: exports.autocomplete ? async (interaction, client, handler) => {
   ...
   */
  private adaptLegacyContextMenuCommand(
    exports: LegacyContextMenuCommandData, 
    filePath: string, 
    commandName: string
  ): LoadedCommand {
    const options = exports.options || {};
    ...
    const builder = new ContextMenuCommandBuilder()
      .setName(exports.data.name)
      .setType(exports.data.type);
   ...
   */
  private adaptModernCommand(
    exports: ModernCommandData, 
    filePath: string, 
    commandName: string
  ): LoadedCommand {
